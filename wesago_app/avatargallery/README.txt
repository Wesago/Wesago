...
If you create gallery named "__default__" and set avatar gallery as default user avatar, Wesago will select new users avatars from it while keeping this gallery hidden from existing users.