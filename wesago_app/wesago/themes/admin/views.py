...
class ThemeAdmin(generic.AdminBaseMixin):
    root_link = "wesago:admin:themes:index"
    model = Theme
    form_class = ThemeForm
    templates_dir = "wesago/admin/themes"
...
class ThemeAssetsAdmin(ThemeAdmin):
    ...
    def redirect_to_theme_assets(self, theme):
        return redirect("wesago:admin:themes:assets", pk=theme.pk)
...
class NewThemeCss(ThemeCssFormAdmin):
    ...
    def redirect_to_edit_form(self, theme, css):
        return redirect("wesago:admin:themes:edit-css-file", pk=theme.pk, css_pk=css.pk)
...
class NewThemeCssLink(ThemeCssFormAdmin):
    ...
    def redirect_to_edit_form(self, theme, css):
        return redirect("wesago:admin:themes:new-css-link", pk=theme.pk)
...
class EditThemeCssLink(NewThemeCssLink):
    ...
    def redirect_to_edit_form(self, theme, css):
        return redirect("wesago:admin:themes:edit-css-link", pk=theme.pk, css_pk=css.pk)
