...
class CategoryRoleAdmin(generic.AdminBaseMixin):
    root_link = "wesago:admin:permissions:categories:index"
    model = CategoryRole
    templates_dir = "wesago/admin/categoryroles"
...
CategoriesList.add_item_action(
    ...
    link="wesago:admin:categories:permissions-deprecated",
)
...
RolesList.add_item_action(
    ...
    link="wesago:admin:permissions:categories",
)
