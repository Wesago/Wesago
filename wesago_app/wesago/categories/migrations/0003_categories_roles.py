...
def create_default_categories_roles(apps, schema_editor):
    ...
    CategoryRole.objects.create(
        ...
        permissions={
            # categories perms
            "wesago.categories.permissions": {"can_see": 1, "can_browse": 0}
        },
    )
    ...
    read_only = CategoryRole.objects.create(
        ...
        permissions={
            # categories perms
            "wesago.categories.permissions": {"can_see": 1, "can_browse": 1},
            # threads perms
    ...
    Category = apps.get_model("wesago_categories", "Category")
    Role = apps.get_model("wesago_acl", "Role")
    RoleCategoryACL = apps.get_model("wesago_categories", "RoleCategoryACL")
...
class Migration(migrations.Migration):
    dependencies = [
        ("wesago_categories", "0002_default_categories"),
