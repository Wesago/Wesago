...
class CopyGroupPermissionsHookAction(Protocol):
    """
    A standard Wesago function used to copy permissions from one user group to another
...
class CopyGroupPermissionsHook(
    ...
    """
    This hook wraps the standard function that Wesago uses to copy group permissions.
    ...
    ```python
    from django.http import HttpRequest
    from wesago.permissions.hooks import copy_group_permissions_hook
