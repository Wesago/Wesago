...
class CopyCategoryPermissionsHookAction(Protocol):
    """
    A standard Wesago function used to copy permissions from one category to another
...
class CopyCategoryPermissionsHook(
    ...
    """
    This hook wraps the standard function that Wesago uses to copy category permissions.
    ...
    ```python
    from django.http import HttpRequest
    from wesago.permissions.hooks import copy_category_permissions_hook
    from wesago.users.models import Category
