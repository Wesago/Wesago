...
class BuildUserPermissionsHookAction(Protocol):
    """
    A standard Wesago function used to build user permissions from their groups.
...
class BuildUserPermissionsHook(
    ...
    """
    This hook wraps the standard function that Wesago uses to build user permissions
    from their groups.
