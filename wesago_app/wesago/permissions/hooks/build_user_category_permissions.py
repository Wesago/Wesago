...
class BuildUserCategoryPermissionsHookAction(Protocol):
    """
    A standard Wesago function used to get user category permissions.
...
class BuildUserCategoryPermissionsHookFilter(Protocol):
    ...
    A standard Wesago function used to build user category permissions or the next
...
class BuildUserCategoryPermissionsHook(
    ...
    """
    This hook wraps the standard function that Wesago uses to build user category
    permissions.
    ...
    ```python
    from wesago.categories.models import Category
    from wesago.permissions.enums import CategoryPermission
    from wesago.permissions.hooks import build_user_category_permissions_hook
    from wesago.users.models import Group
