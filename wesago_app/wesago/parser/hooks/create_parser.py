...
class CreateParserHookAction(Protocol):
    """
    A standard Wesago function used to create a markup parser instance or the
...
class CreateParserHook(FilterHook[CreateParserHookAction, CreateParserHookFilter]):
    """
    This hook wraps the standard function that Wesago uses to create a markup
    parser instance.
    ...
    from wesago.parser.parser import Parser
