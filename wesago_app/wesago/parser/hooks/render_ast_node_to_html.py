...
class RenderAstNodeToHtmlHookAction(Protocol):
    """
    A standard Wesago function used to create an HTML representation of the abstract
...
class RenderAstNodeToHtmlHook(
    ...
    """
    This hook wraps the standard function that Wesago uses to create an HTML
