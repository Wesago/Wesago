...
class CompleteMarkupHtmlHookAction(Protocol):
    """
    A standard Wesago function used to complete an HTML representation of parsed markup
...
class CompleteMarkupHtmlHook(
    ...
    """
    This hook wraps the standard function that Wesago uses to complete an HTML
    ...
    from wesago.parser.html import SPOILER_SUMMARY
