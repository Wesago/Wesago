...
class RenderAstNodeToPlainTextHookAction(Protocol):
    """
    A standard Wesago function used to create a plain text representation of the
...
class RenderAstNodeToPlainTextHook(
    ...
    """
    This hook wraps the standard function that Wesago uses to create a plain text
