...
class AdminSite:
    ...
    def build_nodes_dict(self):
        nodes_dict = {"wesago:admin": Node(link="wesago:admin:index")}
        ...
        while self.nodes_record:
            ...
            if iterations > 1024:
                message = (
                    "Wesago Admin hierarchy is invalid or too complex to resolve. "
                    "Nodes left: %s"
                )
    ...
    def add_node(
        ...
        *,
        ...
        if self.nodes_dict:
            raise RuntimeError(
                "Wesago admin site has already been initialized. "
