...
from ..momentjs import WESAGO_ADMIN_MOMENT_LOCALES
from .auth import login


def get_protected_namespace(request):
    for namespace in settings.WESAGO_ADMIN_NAMESPACES:
        try:
...
def get_admin_moment_locale_url():
    return get_locale_url(
        get_language(),
        static_path_template="wesago/admin/momentjs/%s.js",
        locales=WESAGO_ADMIN_MOMENT_LOCALES,
    )
