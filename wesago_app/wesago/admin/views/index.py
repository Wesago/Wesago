...
VERSION_CHECK_CACHE_KEY = "wesago_version_check"
...
def admin_index(request):
    ...
    return render(
        request,
        "wesago/admin/dashboard/index.html",
        {"totals": totals, "checks": checks},
    )


def check_cache():
    cache.set("wesago_cache_test", "ok")
    return {"is_ok": cache.get("wesago_cache_test") == "ok"}
