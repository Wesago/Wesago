...
class GroupAdmin(generic.AdminBaseMixin):
    root_link = "wesago:admin:groups:index"
    templates_dir = "wesago/admin/groups"
    model = Group
...
class MembersView(GroupAdmin, generic.TargetedView):
    def real_dispatch(self, request, target):
        redirect_url = reverse("wesago:admin:users:index")
...
class NewView(GroupAdmin, generic.ModelFormView):
    ...
    def handle_form(self, form, request, target):
        ...
        return redirect("wesago:admin:groups:edit", pk=group.pk)
