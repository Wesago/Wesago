...
def test_version_check_query_returns_error_if_wesago_version_is_unreleased(
    admin_graphql_client, mocker
):
    mocker.patch("wesago.graphql.admin.versioncheck.__released__", False)
...
def test_version_check_query_returns_success_if_site_is_updated(
    ...
    mocker.patch("wesago.graphql.admin.versioncheck.__released__", True)
