...
class AgreementForm(forms.ModelForm):
    ...
    is_active = YesNoSwitch(
        ...
        help_text=pgettext_lazy(
            "admin agreement form",
            "If other agreement is already active for this type, it will be unset and replaced with this one. Wesago will ask users who didn't accept this agreement to do so before allowing them to continue using the site.",
        ),
    )
    link = forms.URLField(
