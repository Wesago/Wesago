    ...
    def test_context_processor_no_policy(self):
        ...
        self.assertEqual(
            context_dict,
            {
                ...
                "wesago_agreement": None,
            },
        )

    def test_context_processor_wesago_policy(self):
        """context processor has TOS link to Wesago view"""
        ...
        self.assertEqual(
            context_dict,
            {
                ...
                "PRIVACY_POLICY_URL": reverse("wesago:privacy-policy"),
                "wesago_agreement": {
                    "type": "Privacy policy",
...
class TermsOfServiceTests(AuthenticatedUserTestCase):
    ...
    def test_context_processor_wesago_tos(self):
        """context processor has TOS link to Wesago view"""
        agreement = Agreement.objects.create(
        ...
        self.assertEqual(
            context_dict,
            {
                ...
                "TERMS_OF_SERVICE_URL": reverse("wesago:terms-of-service"),
                "PRIVACY_POLICY_ID": None,
                "PRIVACY_POLICY_TITLE": None,
                "PRIVACY_POLICY_URL": None,
                "wesago_agreement": {
