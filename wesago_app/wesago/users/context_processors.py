...
def user_links(request):
    if request.include_frontend_context:
        request.frontend_context.update(
            {
                "REQUEST_ACTIVATION_URL": reverse("wesago:request-activation"),
                "FORGOTTEN_PASSWORD_URL": reverse("wesago:forgotten-password"),
                "BANNED_URL": reverse("wesago:banned"),
                "USERCP_URL": reverse("wesago:options"),
                "USERS_LIST_URL": reverse("wesago:users"),
                "AUTH_API": reverse("wesago:api:auth"),
                "AUTH_CRITERIA_API": reverse("wesago:api:auth-criteria"),
                "USERS_API": reverse("wesago:api:user-list"),
                "CAPTCHA_API": reverse("wesago:api:captcha-question"),
                "USERNAME_CHANGES_API": reverse("wesago:api:usernamechange-list"),
                "MENTION_API": reverse("wesago:api:mention-suggestions"),
            }
        )
