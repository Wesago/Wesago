...
logger = logging.getLogger("wesago.users.ProfileFields")
        ...
        logger.info(
            ...
            extra={
                "absolute_url": request.build_absolute_uri(
                    reverse(
                        "wesago:user-details", kwargs={"slug": user.slug, "pk": user.pk}
                    )
                )
            },
        )
...
profilefields = ProfileFields(settings.WESAGO_PROFILE_FIELDS)
