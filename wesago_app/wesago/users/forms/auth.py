...
class AuthenticationForm(WesagoAuthMixin, BaseAuthenticationForm):
    """
    Base class for authenticating users, Floppy-forms and
    Wesago login field compliant
    """
...
class GetUserForm(WesagoAuthMixin, forms.Form):
