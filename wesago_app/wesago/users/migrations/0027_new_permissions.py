    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=django.contrib.postgres.indexes.GinIndex(
                fields=["plugin_data"], name="wesago_user_plugin__e41d7b_gin"
            ),
        ),
        migrations.AddField(
            model_name="user",
        ...
        migrations.AddIndex(
            model_name="user",
            index=django.contrib.postgres.indexes.GinIndex(
                fields=["groups_ids"], name="wesago_user_groups_ids"
            ),
        ),
        migrations.AddField(
            model_name="user",
        ...
        migrations.AddIndex(
            model_name="user",
            index=models.Index(
                condition=models.Q(("is_wesago_root", True)),
            ...
            options={
                ...
                "indexes": [
                    django.contrib.postgres.indexes.GinIndex(
                        fields=["plugin_data"], name="wesago_user_plugin__065d95_gin"
                    )
                ],
            },
        ),
