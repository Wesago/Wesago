...
def create_default_groups(apps, schema_editor):
    Group = apps.get_model("wesago_users", "Group")
    ...
    GroupDescription = apps.get_model("wesago_users", "GroupDescription")
...
def set_users_default_groups(apps, schema_editor):
    User = apps.get_model("wesago_users", "User")
    ...
    User.objects.filter(is_superuser=True).update(is_wesago_root=True)
...
class Migration(migrations.Migration):
    dependencies = [
        ("wesago_users", "0027_new_permissions"),
    ]
    ...
    operations = [
        ...
        migrations.RunSQL(
            f"ALTER SEQUENCE wesago_users_group_id_seq RESTART WITH {CUSTOM_GROUP_ID_START};",
