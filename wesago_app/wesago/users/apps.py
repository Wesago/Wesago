...
class WesagoUsersConfig(AppConfig):
    name = "wesago.users"
    label = "wesago_users"
    verbose_name = "Wesago Users"
    ...
    def register_default_usercp_pages(self):
        ...
        usercp.add_section(
            link="wesago:usercp-change-email-password",
        ...
        usercp.add_section(
            link="wesago:usercp-download-data",
        ...
        usercp.add_section(
            link="wesago:usercp-delete-account",
    ...
    def register_default_users_list_pages(self):
        users_list.add_section(
            link="wesago:users-active-posters",
