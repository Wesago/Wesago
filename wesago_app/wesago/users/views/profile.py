...
class ProfileView(View):
    ...
    def get_profile(self, request, pk, slug):
        ...
        if not profile.is_active and not request.user.is_wesago_admin:
            raise Http404()
...
class UserPostsView(ProfileView):
    template_name = "wesago/profile/posts.html"
...
class UserThreadsView(ProfileView):
    template_name = "wesago/profile/threads.html"
...
class UserFollowersView(ProfileView):
    template_name = "wesago/profile/followers.html"
...
class UserFollowsView(ProfileView):
    template_name = "wesago/profile/follows.html"
...
class UserProfileDetailsView(ProfileView):
    template_name = "wesago/profile/details.html"
...
class UserUsernameHistoryView(ProfileView):
    template_name = "wesago/profile/username_history.html"
...
class UserBanView(ProfileView):
    template_name = "wesago/profile/ban_details.html"
