...
def index(request, *args, **kwargs):
    ...
    return render(request, "wesago/options/noscript.html")
...
def confirm_change_view(f):
    ...
    def decorator(request, token):
        try:
            ...
            return render(request, "wesago/options/credentials_error.html", status=400)
...
def confirm_email_change(request, token):
    ...
    return render(
        request,
        "wesago/options/credentials_changed.html",
