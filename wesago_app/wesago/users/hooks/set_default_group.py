...
class SetDefaultGroupHookAction(Protocol):
    """
    A standard Wesago function used to set the default user group, or the next
...
class SetDefaultGroupHook(
    ...
    """
    This hook wraps the standard function that Wesago uses to set a default user group.
