...
class DeleteGroupHookAction(Protocol):
    """
    A standard Wesago function used for deleting the user group, or the next
...
class DeleteGroupHook(FilterHook[DeleteGroupHookAction, DeleteGroupHookFilter]):
    """
    This hook wraps the standard function that Wesago uses to delete a user group.

    Wesago executes delete queries for groups and their relations directly, skipping
