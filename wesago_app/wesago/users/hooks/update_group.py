...
class UpdateGroupHookAction(Protocol):
    """
    A standard Wesago function used to update an existing user group or the next filter
...
class UpdateGroupHook(FilterHook[UpdateGroupHookAction, UpdateGroupHookFilter]):
    """
    This hook wraps the standard function that Wesago uses to update user group.
