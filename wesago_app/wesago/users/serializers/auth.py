...
class AuthenticatedUserSerializer(UserSerializer, AuthFlags):
    ...
    def get_api(self, obj):
        return {
            "avatar": reverse("wesago:api:user-avatar", kwargs={"pk": obj.pk}),
            "data_downloads": reverse(
                "wesago:api:user-data-downloads", kwargs={"pk": obj.pk}
            ),
            "details": reverse("wesago:api:user-details", kwargs={"pk": obj.pk}),
            "change_email": reverse(
                "wesago:api:user-change-email", kwargs={"pk": obj.pk}
            ),
            "change_password": reverse(
                "wesago:api:user-change-password", kwargs={"pk": obj.pk}
            ),
            "edit_details": reverse(
                "wesago:api:user-edit-details", kwargs={"pk": obj.pk}
            ),
            "options": reverse("wesago:api:user-forum-options", kwargs={"pk": obj.pk}),
            "request_data_download": reverse(
                "wesago:api:user-request-data-download", kwargs={"pk": obj.pk}
            ),
            "username": reverse("wesago:api:user-username", kwargs={"pk": obj.pk}),
            "delete": reverse(
                "wesago:api:user-delete-own-account", kwargs={"pk": obj.pk}
            ),
        }
