...
class FilterUserDataHook(
    ...
    """
    This hook wraps the standard function that Wesago uses to filter a Python `dict`
    ...
    `name` into a valid Wesago username (e.g., `Łukasz Kowalski` becomes
    ...
    ```python
    from django.http import HttpRequest
    from wesago.oauth.hooks import filter_user_data_hook
