...
class ForumThreadsList(ThreadsList):
    ...
    template_name = "wesago/threadslist/threads.html"

    def get_default_frontend_context(self):
        return {"MERGE_THREADS_API": reverse("wesago:api:thread-merge")}


class CategoryThreadsList(ForumThreadsList):
    category = ThreadsCategory

    template_name = "wesago/threadslist/category.html"
...
class PrivateThreadsList(ThreadsList):
    ...
    template_name = "wesago/threadslist/private_threads.html"
