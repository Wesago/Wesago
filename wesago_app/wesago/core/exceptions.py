...
class AjaxError(Exception):
    """You've tried to do something over AJAX but wesago blurped"""
...
class SocialAuthFailed(AuthException):
    """Exception used to return error messages from Wesago's social auth to user."""
...
class SocialAuthBanned(AuthException):
    """Exception used to return ban message from Wesago's social auth to user."""
