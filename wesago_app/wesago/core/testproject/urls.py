...
# Setup Django admin to work with Wesago auth
...
urlpatterns = [
    ...
    path("forum/", include("wesago.urls", namespace="wesago")),
    path("django-admin/", admin.site.urls),
    path(
        "django-i18n.js",
        cache_page(86400 * 2, key_prefix="wesagojsi18n")(
    ...
    path("forum/test-banned/", views.raise_wesago_banned, name="raise-wesago-banned"),
    path("forum/test-403/", views.raise_wesago_403, name="raise-wesago-403"),
    path("forum/test-404/", views.raise_wesago_404, name="raise-wesago-404"),
    path("forum/test-405/", views.raise_wesago_405, name="raise-wesago-405"),
    path(
