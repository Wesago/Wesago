...
def raise_wesago_banned(request):
    ban = Ban(user_message="Banned for test!")
    raise Banned(ban)


def raise_wesago_403(request):
    raise PermissionDenied("Wesago 403")


def raise_wesago_404(request):
    raise Http404("Wesago 404")


def raise_wesago_405(request):
