...
class SiteTests(TestCase):
    ...
    def test_pages(self):
        ...
        self.page.add_section(
            link="wesago:user-posts", name="Posts", after="wesago:user-threads"
        )

        self.page.add_section(link="wesago:user-threads", name="Threads")

        self.page.add_section(
            link="wesago:user-follows", name="Follows", before="wesago:user-posts"
        )
        ...
        self.assertEqual(self.page.get_default_link(), "wesago:user-threads")
