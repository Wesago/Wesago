...
from ..templatetags.wesago_absoluteurl import absoluteurl
...
def test_link_is_reversed_and_prefixed_with_forum_address(context):
    assert absoluteurl(context, "wesago:index") == "http://test.com/"


def test_absolute_url_is_not_changed(context):
    url = "https://github.com/rafalp/Wesago/issues/1067"
