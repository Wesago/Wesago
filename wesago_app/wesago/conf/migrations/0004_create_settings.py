...
default_settings = [
    ...
    {"setting": "email_footer"},
    {
        ...
        "dry_value": getattr(settings, "WESAGO_ADDRESS", None),
        "is_public": True,
    },
    {"setting": "forum_footnote", "is_public": True},
    {"setting": "forum_name", "dry_value": "Wesago", "is_public": True},
    ...
    {"setting": "logo_text", "dry_value": "Wesago", "is_public": True},
...
class Migration(migrations.Migration):
    dependencies = [
        ("wesago_conf", "0003_simplify_models"),
        ("wesago_core", "0003_delete_cacheversion"),
        ("wesago_threads", "0012_set_dj_partial_indexes"),
        ("wesago_users", "0020_set_dj_partial_indexes"),
    ]
