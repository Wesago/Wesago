...
def test_accessing_attr_returns_setting_value_defined_in_wesago_defaults_file(settings):
    assert settings.WESAGO_MOMENT_JS_LOCALES
...
def test_default_setting_value_can_be_overridden_using_django_util(settings):
    with override_settings(WESAGO_MOMENT_JS_LOCALES="test"):
        assert settings.WESAGO_MOMENT_JS_LOCALES == "test"
