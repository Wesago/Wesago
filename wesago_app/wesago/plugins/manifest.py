...
class WesagoPlugin:
    ...
    The code below shows a `wesago_plugin.py` file with a plugin manifest with all
    fields filled in:

    ```python
    from wesago import WesagoPlugin
    ...
    manifest = WesagoPlugin(
        ...
        help="https://wesago-project.org/c/support/30/",
        bugs="https://wesago-project.org/c/bug-reports/29/",
        repo="https://github.com/rafalp/wesago",
    )
    ```
    """
